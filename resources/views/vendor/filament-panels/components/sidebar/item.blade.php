...
@php
    ...
    $hasChildItems = filled($childItems) && count($childItems);
@endphp
...
<li
    ...
    {{
        $attributes->class([
            ...
            'flex flex-col gap-y-1' => $hasChildItems || $active || $activeChildItems,
        ])
    }}
>
    @if ($hasChildItems)
                ...
                >
                    ...
                    <div
                        @class([
                            ...
                            'bg-gray-400 dark:bg-gray-500' => ! ($active || $activeChildItems),
                            'bg-primary-600 dark:bg-primary-400' => $active || $activeChildItems,
                        ])
                    ></div>
                </div>
            @endif
    ...
    @if ($hasChildItems)
        <ul class="fi-sidebar-sub-group-items flex flex-col gap-y-1" x-show="open" x-collapse.duration.200ms>
